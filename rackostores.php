...
class Rackostores extends Module
{
  ...
  public function hookDisplayFooter()
  {
    ...
    $showrooms = Store::getStores(1);
    foreach ($showrooms as $key => $value) {
      $showrooms[$key]['country'] = Country::getNameById($idLang, (int)$value['id_country']);
      $showrooms[$key]['state'] = State::getNameById((int)$value['id_state']);
    }
    ...
    $this->context->smarty->assign(array(
      ...
      'showrooms' => $showrooms,
      'stores_wordwide' => $arreglo_wordlwide,
      'lang' => $idLang
    ));
